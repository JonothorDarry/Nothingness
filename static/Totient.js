class Totient_CRT extends Partial{
	presentation(){
		...
		grid.single_filler([-1, -1], 'n\\m', {'color':101});
		this.buttons.upper = grid.filler([-1, [0, this.logic.m-1]], ArrayUtils.range(0, this.logic.m-1), {'color':5});
		this.buttons.lefty = grid.filler([[0, this.logic.n-1], -1], ArrayUtils.range(0, this.logic.n-1), {'color':5});
