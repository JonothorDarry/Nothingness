...
class BinaryExpo extends Algorithm{
	...
	presentation_create_a_powers(){
		...
		var a=this.logic.a;
		gridy.filler([0, [0, this.logic.powers_2.length-1]], ArrayUtils.revert(this.logic.powers_2).map(x => (`${a}<sup>${x}</sup>`)), {'color':5, 'stylistic':{'px':{'width':width_for_mod}}});
		this.buttons.a_powers = gridy.filler([1, [0, this.logic.powers_2.length-1]], ArrayUtils.revert(this.logic.a_powers), {'color':4, 'stylistic':{'px':{'width':width_for_mod}}});
	...
	presentation_create_results(){
		...
		Modern_representation.button_modifier(regular_power.base, {'stylistic':{'px':{'width':width_for_mod}}});
		...
		this.buttons.res = this.presentation_make_paint_append('1', {'px':{'width':width_for_mod}}, full_div, 0);
		...
		this.buttons.mod = this.presentation_make_paint_append(`(mod ${this.logic.m})`, {'general':{'color':'#000000'}, 'px':{'width':width_for_mod + 60}}, full_div, 102);
